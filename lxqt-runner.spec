...
Version  : 1.2.0
Release  : 11
URL      : https://github.com/lxqt/lxqt-runner/releases/download/1.2.0/lxqt-runner-1.2.0.tar.xz
Source0  : https://github.com/lxqt/lxqt-runner/releases/download/1.2.0/lxqt-runner-1.2.0.tar.xz
Source1  : https://github.com/lxqt/lxqt-runner/releases/download/1.2.0/lxqt-runner-1.2.0.tar.xz.asc
...
%prep
%setup -q -n lxqt-runner-1.2.0
cd %{_builddir}/lxqt-runner-1.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667857456
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/lxqt-runner-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/lxqt-runner/7fab4cd4eb7f499d60fe183607f046484acd6e2d || :
pushd clr-build
%make_install
popd
...
/usr/share/lxqt/translations/lxqt-runner/lxqt-runner_hi.qm
